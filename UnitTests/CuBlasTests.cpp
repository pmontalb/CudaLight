...
namespace clt
{
	...
	static cl::mat GetInvertibleMatrix(unsigned nRows, const unsigned seed = 1234)
	{
	...
	TEST_F(CuBlasTests, SubMultiply)
	{
		...
		cl::mat m3(m1.nRows(), m2.nCols(), -123456789.0f);
	...
	TEST_F(CuBlasTests, CountEquals)
	{
		...
		cl::vec w = cl::vec::LinSpace(-3.14f, 3.14f, u.size());
