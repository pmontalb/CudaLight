...
namespace clt
{
	...
	TEST_F(HostExtraRoutinesTests, Sum)
	{
		...
		auto v1 = cl::host::DebugDoubleVector::LinSpace(-1.0, 1.0, size);
		auto _v1 = v1.Get();
		...
		auto v2 = cl::host::DebugSingleVector::LinSpace(-1.0, 1.0, size + 1);
		auto _v2 = v2.Get();
		...
		cl::host::DebugIntegerVector v3(size, 1);
		auto _v3 = v3.Get();
	...
	{
		auto x = cl::host::DebugSingleVector::LinSpace(-1.0f, 1.0f, 128);
		auto _x = x.Get();
