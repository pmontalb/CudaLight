...
//CuSparseWrappers
__CREATE_FUNCTION_1_ARG(AllocateCsrHandle, CuSparseKernelExceptionFactory, SparseMemoryTile&, A)
__CREATE_FUNCTION_1_ARG(DestroyCsrHandle, CuSparseKernelExceptionFactory, SparseMemoryTile&, A)
