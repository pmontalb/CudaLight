...
namespace cl { namespace host
{
	 ...
	 * CRTP implementation
	 */
	template<typename BufferImpl, MemorySpace memorySpace = MemorySpace::Test, MathDomain mathDomain = MathDomain::Float>
	...
	public:
		...
		template<typename bi, MemorySpace ms = MemorySpace::Test, MathDomain md = MathDomain::Float>
