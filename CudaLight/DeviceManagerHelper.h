...
__CREATE_FUNCTION_1_ARG(Reciprocal, MemoryBuffer&, buf)
...
__CREATE_FUNCTION_2_ARG(ScaleColumns, MemoryTile&, z, const MemoryBuffer&, alpha)
...
__CREATE_FUNCTION_7_ARG(Multiply, MemoryTile&, A, const MemoryTile&, B, const MemoryTile&, C, const MatrixOperation, bOperation, const MatrixOperation, cOperation, const double, alpha, const double, beta)
__CREATE_FUNCTION_10_ARG(SubMultiply, MemoryTile&, A, const MemoryTile&, B, const MemoryTile&, C, const unsigned, nRowsB, const unsigned, nColsB, const unsigned, nColsC, const MatrixOperation, bOperation, const MatrixOperation, cOperation, const double, alpha, const double, beta)
__CREATE_FUNCTION_9_ARG(BatchedMultiply, MemoryCube&, A, const MemoryCube&, B, const MemoryCube&, C, const unsigned, strideB, const unsigned, strideC, const MatrixOperation, bOperation, const MatrixOperation, cOperation, const double, alpha, const double, beta)
...
__CREATE_FUNCTION_4_ARG(RowWiseSum, MemoryBuffer&, x, const MemoryTile&, A, MemoryBuffer&, cache, const MatrixOperation, aOperation = MatrixOperation::None)
__CREATE_FUNCTION_4_ARG(CubeWiseSum, MemoryTile&, A, const MemoryCube&, T, MemoryCube&, cacheReshape, MemoryBuffer&, cacheOnes)
...
//CuSparseWrappers
__CREATE_FUNCTION_1_ARG(AllocateCsrHandle, SparseMemoryTile&, A)
__CREATE_FUNCTION_1_ARG(DestroyCsrHandle, SparseMemoryTile&, A)
