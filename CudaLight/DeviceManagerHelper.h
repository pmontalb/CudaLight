...
__CREATE_FUNCTION_5_ARG(AddEqualMatrix, MemoryTile, A, const MemoryTile, B, const MatrixOperation, aOperation = MatrixOperation::None, const MatrixOperation, bOperation = MatrixOperation::None, const double, alpha = 1.0);
...
__CREATE_FUNCTION_8_ARG(Multiply, MemoryTile, A, const MemoryTile, B, const MemoryTile, C, const unsigned, leadingDimensionB, const unsigned, leadingDimensionC, const MatrixOperation, bOperation = MatrixOperation::None, const MatrixOperation, cOperation = MatrixOperation::None, const double, alpha = 1.0);
__CREATE_FUNCTION_5_ARG(Dot, MemoryBuffer, y, const MemoryTile, A, const MemoryBuffer, x, const MatrixOperation, aOperation = MatrixOperation::None, const double, alpha = 1.0);
