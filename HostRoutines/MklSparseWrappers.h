	...
	namespace routines
	{
		namespace mkr
		{
			...
			inline void AllocateCsrHandle<MathDomain::Float>(SparseMemoryTile& A)
			{
				...
				mkl::mkl_sparse_s_create_csr(&sparseA, mkl::sparse_index_base_t::SPARSE_INDEX_BASE_ZERO, static_cast<int>(A.nRows), static_cast<int>(A.nCols), reinterpret_cast<int*>(A.nNonZeroRows), reinterpret_cast<int*>(A.nNonZeroRows) + 1, reinterpret_cast<int*>(A.nonZeroColumnIndices), reinterpret_cast<float*>(A.pointer));
			...
			{
				mkl::sparse_matrix_t sparseA;
				mkl::mkl_sparse_d_create_csr(&sparseA, mkl::sparse_index_base_t::SPARSE_INDEX_BASE_ZERO, static_cast<int>(A.nRows), static_cast<int>(A.nCols), reinterpret_cast<int*>(A.nNonZeroRows), reinterpret_cast<int*>(A.nNonZeroRows) + 1, reinterpret_cast<int*>(A.nonZeroColumnIndices), reinterpret_cast<double*>(A.pointer));
			...
			inline void SparseDot<MathDomain::Float>(MemoryBuffer& y, SparseMemoryTile& A, const MemoryBuffer& x, const MatrixOperation aOperation, const double alpha, const double beta)
			{
				...
				mkl::mkl_sparse_s_mv(mklSparseOperations[static_cast<size_t>(aOperation)], static_cast<float>(alpha), reinterpret_cast<mkl::sparse_matrix_t>(A.thirdPartyHandle), descr, reinterpret_cast<float*>(x.pointer), static_cast<float>(beta), reinterpret_cast<float*>(y.pointer));
			}
			template<>
			inline void SparseDot<MathDomain::Double>(MemoryBuffer& y, SparseMemoryTile& A, const MemoryBuffer& x, const MatrixOperation aOperation, const double alpha, const double beta)
			{
				...
				descr.mode = mkl::sparse_fill_mode_t::SPARSE_FILL_MODE_FULL;
				descr.type = mkl::sparse_matrix_type_t::SPARSE_MATRIX_TYPE_GENERAL;
				mkl::mkl_sparse_d_mv(mklSparseOperations[static_cast<size_t>(aOperation)], alpha, reinterpret_cast<mkl::sparse_matrix_t>(A.thirdPartyHandle), descr, reinterpret_cast<double*>(x.pointer), beta, reinterpret_cast<double*>(y.pointer));
			}
			...
			inline void SparseMultiply<MathDomain::Float>(MemoryTile& A, SparseMemoryTile& B, const MemoryTile& C, const MatrixOperation bOperation, const double alpha)
			{
				...
				descr.mode = mkl::sparse_fill_mode_t::SPARSE_FILL_MODE_FULL;
				descr.type = mkl::sparse_matrix_type_t::SPARSE_MATRIX_TYPE_GENERAL;
				mkl::mkl_sparse_s_mm(mklSparseOperations[static_cast<size_t>(bOperation)], static_cast<float>(alpha), reinterpret_cast<mkl::sparse_matrix_t>(B.thirdPartyHandle), descr, mkl::sparse_layout_t::SPARSE_LAYOUT_COLUMN_MAJOR, reinterpret_cast<float*>(C.pointer), static_cast<int>(A.nCols), static_cast<int>(C.leadingDimension), 0.0f, reinterpret_cast<float*>(A.pointer), static_cast<int>(A.leadingDimension));
			}
			template<>
			inline void SparseMultiply<MathDomain::Double>(MemoryTile& A, SparseMemoryTile& B, const MemoryTile& C, const MatrixOperation bOperation, const double alpha)
			{
				...
				descr.mode = mkl::sparse_fill_mode_t::SPARSE_FILL_MODE_FULL;
				descr.type = mkl::sparse_matrix_type_t::SPARSE_MATRIX_TYPE_GENERAL;
				mkl::mkl_sparse_d_mm(mklSparseOperations[static_cast<size_t>(bOperation)], alpha, reinterpret_cast<mkl::sparse_matrix_t>(B.thirdPartyHandle), descr, mkl::sparse_layout_t::SPARSE_LAYOUT_COLUMN_MAJOR, reinterpret_cast<double*>(C.pointer), static_cast<int>(A.nCols), static_cast<int>(A.leadingDimension), 0.0, reinterpret_cast<double*>(A.pointer), static_cast<int>(A.leadingDimension));
			}
			...
			inline void SparseSolve<MathDomain::Float>(SparseMemoryTile& A, MemoryTile& B, LinearSystemSolverType solver)
			{
				...
				switch (solver)
				{
					case LinearSystemSolverType::Qr:
					{
						...
						err = mkl::mkl_sparse_s_qr_solve(mkl::SPARSE_OPERATION_NON_TRANSPOSE, reinterpret_cast<mkl::sparse_matrix_t>(A.thirdPartyHandle), reinterpret_cast<float*>(aCopy.pointer), mkl::SPARSE_LAYOUT_COLUMN_MAJOR, static_cast<int>(B.nCols), reinterpret_cast<float*>(B.pointer), static_cast<int>(B.leadingDimension), reinterpret_cast<float*>(B.pointer), static_cast<int>(B.leadingDimension));
						if (err != mkl::SPARSE_STATUS_SUCCESS)
							throw MklException(__func__);
			...
			inline void SparseSolve<MathDomain::Double>(SparseMemoryTile& A, MemoryTile& B, LinearSystemSolverType solver)
			{
				...
				switch (solver)
				{
					case LinearSystemSolverType::Qr:
					{
						...
						err = mkl::mkl_sparse_d_qr_solve(mkl::SPARSE_OPERATION_NON_TRANSPOSE, reinterpret_cast<mkl::sparse_matrix_t>(A.thirdPartyHandle), reinterpret_cast<double*>(aCopy.pointer), mkl::SPARSE_LAYOUT_COLUMN_MAJOR, 1, reinterpret_cast<double*>(B.pointer), static_cast<int>(B.leadingDimension), reinterpret_cast<double*>(B.pointer), static_cast<int>(B.leadingDimension));
						if (err != mkl::SPARSE_STATUS_SUCCESS)
							throw MklException(__func__);
